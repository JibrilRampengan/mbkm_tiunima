        ...
        <main>
            <div class="head-title-dashboard">
                <div class="left-dashboard">
                    ...
                    <p>Anda berada di halaman<b> "Berita Acara" </b>didalam halaman ini anda dapat mencetak berita acara hasil konversi nilai matakuliah anda</p>
                </div>
            </div>
            ...
            <div class="card card-input-matakuliah">
                <div class="card-header card-header-input-matakuliah">
                    <p>Daftar Data Berita Acara</p>
                </div>

                <!-- Tabel untuk menampilkan data mahasiswa -->
                <table id="tablepilihdata" class="ui celled table nowrap unstackable" style="width:100%">
                    <thead>
                        <tr>
                            <th>No</th>
