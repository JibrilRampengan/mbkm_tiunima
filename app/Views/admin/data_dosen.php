...
<body>
        ...
        <main>
            <div class="head-title-dashboard">
                <div class="left-dashboard">
                    <h1>Data Dosen Program Studi</h1>
                    <br>
                    <h2>Halo, <span class="small-text-dashboard"><?php echo $_SESSION["username"]; ?></h2>
                    <p>Anda berada di halaman<b> " Data Dosen Program Studi " </b>Pada halaman ini anda bisa melihat, menambah dan menghapus data dosen program studi.</p>
                </div>
            </div>
            <br>
            ...
            <div class="card-validasi-data">
                <div class="card-header-validasi-data">
                    <p>Validasi Data</p>
                    <button id="btnTambahDosen" class="ui blue button">Tambah Dosen</button>
                </div>
                ...
                <div id="modalTambahDosen" class="ui modal">
                    <i class="close icon"></i>
                    <div class="header">
                        Tambah Dosen
                    </div>
                    <div class="content">
                        <form method="post" action="/admin/data_dosen">
                            <?= csrf_field() ?>
                            <div class="ui form">
                                ...
                                <input type="text" name="nip_dosen" required>
                                <br>
                                <br>
                                <button class="ui button" type="submit">Tambah Dosen</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($dosenData as $dosen) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="confirmDelete(<?= $dosen['id'] ?>)" class="ui red button">Hapus</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <!-- Sweet Alert untuk konfirmasi penghapusan data dosen -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
    <script>
        function confirmDelete(dosenId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/admin/delete_dosen/' + dosenId;
                }
            });
        }
    </script>
