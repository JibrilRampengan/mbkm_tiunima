        ...
        <main>
            ...
            <div class="card-validasi-data">
                <div class="card-header-validasi-data">
                    <p>Validasi Data Konversi Nilai</p>
                </div>

                <form action="/admin/proses_validasi_konversi_nilai" method="post">
                    <table id="pilihdata" class="ui celled table nowrap unstackable" style="width:100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <!-- <th>Grup ID</th> -->
                        ...
                        <tbody>
                            ...
                            <?php foreach ($grupIds as $grupId) : ?>
                                <?php $dataKonversiNilai = $adminModel->getKonversiNilaiByGrupId($grupId['grup_id']); ?>
                                <?php $status = $adminModel->getGrupIdStatus($grupId['grup_id']); ?>
                                <?php if (!empty($dataKonversiNilai)) : ?>
                                    <?php $data = $dataKonversiNilai[0]; ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <!-- <td><?= $grupId['grup_id'] ?></td> -->
                                        ...
                                        <td>
                                            <?php if ($status == 'selesai') : ?>
                                                ✓ Selesai Di Proses
                                            <?php else : ?>
                                                <button type="submit" name="grup_id" value="<?= $grupId['grup_id'] ?>">Proses Data</button>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endif; ?>
